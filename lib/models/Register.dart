...
class _Register_as_dealerState extends State<Register_as_dealer> {
  ...
  Future <List> senddata() async {
    ...
    final response = await http.post(Uri.parse("http://192.168.0.132/dashboard/test/register.php"), body: {
      "name": name.text,
      "email": email.text,
      "mobile": mobile.text,
        ...
        body: SafeArea(
          child: Center(
              child: Column(
                ...
                children: [
                  // Hello again
                  const Text("Dealers' Registration form",
                      style: TextStyle(
                  ...
                  const Text(
                      "Enter the specific information of the dealer who wish to put a car on rent.",
                      style: TextStyle(
                        fontSize: 15,
                      )).p(10),
